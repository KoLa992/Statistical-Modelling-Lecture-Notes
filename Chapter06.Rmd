...
Read both worksheets into two separate data frames using the `sheet` parameter in the `read_excel` function of the `readxl` package.
...
Use the Cancer survival data from <a href="Chapter03.html" target="_blank">Chapter 3</a> again for a sample where Exponential distribution is reasonable assumption.
...
### 2.3. Analytically for the Exponential Distribution
...
### 2.6. Analytically for the Normal Distribution
