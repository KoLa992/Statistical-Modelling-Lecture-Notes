...
Partial t-tests indicate that the non-significant explanatory variables at $\alpha=5\%$ are **Prof**, **Unprof**, **FAssets**, **Equity**, **SUBLiab** and **PersExp**. If these variables are not related to the earnings of the industries, they should be dropped from the model:
